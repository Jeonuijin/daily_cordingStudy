...
(SELECT Salary FROM EMPLOYEES E1 WHERE COMMISSION_PCT IS NULL AND E1.EMPLOYEE_ID = E.EMPLOYEE_ID) AS "Salary only",
(SELECT ROUND(SALARY+(SALARY /100 * 12.3)) FROM EMPLOYEES E1 WHERE COMMISSION_PCT IS NOT NULL AND E1.EMPLOYEE_ID = E.EMPLOYEE_ID) AS "Salary + Commission",
(SELECT 'Salary only' FROM EMPLOYEES E1 WHERE COMMISSION_PCT IS NULL AND E1.EMPLOYEE_ID = E.EMPLOYEE_ID) AS A,
(SELECT 'Salary + Commission' FROM EMPLOYEES E1 WHERE COMMISSION_PCT IS NOT NULL AND E1.EMPLOYEE_ID = E.EMPLOYEE_ID) AS B
FROM EMPLOYEES E
