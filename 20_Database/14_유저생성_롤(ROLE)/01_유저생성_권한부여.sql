...
=============================*******/
--(관리자 계정 SYSTEM) 유저 생성권한이 있는 유저에서 작업
-- 사용자 생성 : MDGUEST / mdguest
...
*************************************************/
--권한부여 : MADANG  유저의 BOOK 테이블에 대한 SELECT 권한을 MD게스트에게 MDGUEST에게 부여
...
REVOKE SELECT, UPDATE ON CUSTOMER FROM MDGUEST; --모두취소됨(CASCADE는 디폴드값이다.)
---
--(SYSTEM) 유저삭제는 관리자만 가능
