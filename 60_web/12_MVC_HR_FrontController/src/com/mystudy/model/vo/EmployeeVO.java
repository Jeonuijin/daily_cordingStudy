...
public class EmployeeVO {
	...
	public String getManagerPd() {
		return managerPd;
	}
	public void setManagerPd(String managerPd) {
		this.managerPd = managerPd;
	}
	...
	public String toString() {
		return "EmployeeVO [employeeId=" + employeeId + ", firstName=" + firstName + ", lastName=" + lastName
				...
				+ ", salary=" + salary + ", commissionPct=" + commissionPct + ", managerPd=" + managerPd
