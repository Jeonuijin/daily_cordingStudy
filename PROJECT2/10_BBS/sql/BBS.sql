...
CREATE TABLE COMMENTS (
    ...
    CONSTRAINT COMMMENTS_FK FOREIGN KEY (BBS_IDX) REFERENCES BBS(BBS_IDX) --댓글테이블이 게시글 테이블을 참조
);
--시퀀스 추가
CREATE SEQUENCE BBS_SEQ NOCACHE;		--게시글번호
CREATE SEQUENCE COMMENTS_SEQ NOCACHE;	--댓글번호
-----------------------------------------
