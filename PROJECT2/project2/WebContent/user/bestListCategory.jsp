		...
		<div class="row">
			...
			<tr>
				<td colspan="6">
					...
					<c:if test="${pvo.beginPage != 1 }">
						<li>
							<a href="bestListCategory.jsp?cPage=${pvo.beginPage - 1 }">이전으로</a>
						</li>
					</c:if>	
					...
					<c:if test="${pageNo != pvo.nowPage }">
						<li>
							<a href="bestListCategory.jsp?cPage=${pageNo }">${pageNo }</a>
						</li>
					</c:if>		
					...
					<c:if test="${pvo.endPage < pvo.totalPage }">
						<li>
							<a href="bestListCategory.jsp?cPage=${pvo.endPage + 1 }">다음으로</a>
						</li>
					</c:if>		 
					</ol>
